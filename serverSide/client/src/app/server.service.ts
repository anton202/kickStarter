...
export class ServerService {
  ...
  register(data){
    return this.http.post('http://46.101.194.54/api/user/register',{data}).map(res => res.json());
  }
  ...
  logOut(){
    return this.http.get('4http://46.101.194.54/api/user/logOut');
  }

  createProject(data){
      return this.http.post('http://46.101.194.54/api/user/startProject',{data}).map(res => res.json())
  }
  ...
  viewProject(id){
    return this.http.get('http://46.101.194.54/api/general/viewProject/' +id).map(res => res.json());
  }
  ...
  deleteProject(id){
    return this.http.delete('http://46.101.194.54/api/user/deletProject/'+id).map(res => res.json());
  }
}
